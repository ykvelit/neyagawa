namespace Neyagawa.Core.Options
{
    ...
    public class UnitTestGeneratorOptions : IUnitTestGeneratorOptions
    {
        ...
        public UnitTestGeneratorOptions(IGenerationOptions generationOptions, INamingOptions namingOptions, IStrategyOptions strategyOptions, Dictionary<string, string> membersSetByFilename)
        {
