namespace Neyagawa.Core.Helpers
{
    ...
    public static class CelebrationGenerator
    {
        public static string GetAnimal(out string name)
        {
            ...
            {
                Tuple.Create("Bernard the unit-testing bear", ""),
                Tuple.Create("Charlie the unit-testing cat", ""),
                Tuple.Create("Dominic the unit-testing dinosaur", ""),
                Tuple.Create("Dave the unit-testing dog", ""),
                Tuple.Create("Mike the unit-testing mouse", ""),
                Tuple.Create("Pete the unit-testing pig", ""),
                Tuple.Create("Oliver the unit-testing owl", ""),
                Tuple.Create("Steve the unit-testing spider", ""),
            };
        ...
        public static string GetMessage(string animal, string name, IGenerationStatistics generationStatistics)
        {
            ...
            paddedLines[3 + adder] = paddedLines[3 + adder] + "You have created " + generationStatistics.TestMethodsGenerated.ToString("N0") + " test methods with Neyagawa!";
