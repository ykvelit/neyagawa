namespace Neyagawa.Core
{
    ...
    using Neyagawa.Core.Strategies;
    using Neyagawa.Core.Strategies.ClassDecoration;
    using Neyagawa.Core.Strategies.ClassGeneration;
    using Neyagawa.Core.Strategies.ClassLevelGeneration;
    using Neyagawa.Core.Strategies.IndexerGeneration;
    using Neyagawa.Core.Strategies.InterfaceGeneration;
    using Neyagawa.Core.Strategies.MethodGeneration;
    using Neyagawa.Core.Strategies.OperatorGeneration;
    using Neyagawa.Core.Strategies.PropertyGeneration;
    using Neyagawa.Core.Strategies.ValueGeneration;
