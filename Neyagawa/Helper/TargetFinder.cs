namespace Neyagawa.Helper
{
    ...
    {
        public static FindTargetStatus FindExistingTargetItem(ISymbol symbol, ProjectItemModel source, ProjectMapping mapping, INeyagawaPackage package, IMessageLogger messageLogger, out ProjectItem targetItem, out bool wasRedirection)
        {
...
#pragma warning restore VSTHRD010
        ...
        private static async Task<string> FindTargetByTypeAsync(ISymbol symbol, ProjectItemModel source, ProjectMapping mapping, INeyagawaPackage package, string targetProjectName, Func<string, string> namespaceTransform)
        {
            if (symbol == null)
            {
