namespace Neyagawa.Helper
{
    ...
    {
        public static async Task GenerateCodeAsync(IReadOnlyCollection<GenerationItem> generationItems, bool withRegeneration, INeyagawaPackage package, IMessageLogger messageLogger)
        {
        ...
        private static void CreateUnsavedFile(INeyagawaPackage package, GenerationItem generationItem)
        {
            ThreadHelper.ThrowIfNotOnUIThread();
            ...
            try
            {
                var header = string.IsNullOrWhiteSpace(generationItem.Mapping.TargetProjectName) ?
                     "ElectiveDisconnectedFileHeader" : $"Strings.DisconnectedFileHeader.Replace('$$TARGETNAME$$', generationItem.Mapping.TargetProjectName)";
        ...
        private static void AddTargetItem(INeyagawaPackage package, GenerationItem generationItem, bool withActivation, IMessageLogger logger)
        {
            ThreadHelper.ThrowIfNotOnUIThread();
